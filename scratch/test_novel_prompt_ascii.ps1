$body = "{`"model`":`"qwen3.8-flash`",`"messages`":[{`"role`":`"system`",`"content`":`"Viet tiep tieu thuyet khoa huyen`"},{`"role`":`"user`",`"content`":`"Buoi trua mat dien pin hat nhan roi`"}],`"stream`":true,`"max_tokens`":2048}"
